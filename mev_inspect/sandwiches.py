            ...
            if (
                ...
                if len(sandwiched_swaps) > 0:
                    ...
                    if back_swap.token_in_amount > front_swap.token_out_amount:
                        profit_amount = front_swap.token_in_amount*(back_swap.token_in_amount/back_swap.token_out_amount) - front_swap.token_in_amount
                    
                    if back_swap.token_in_amount < front_swap.token_out_amount:
                        profit_amount = back_swap.token_out_amount - front_swap.token_in_amount*(back_swap.token_in_amount/front_swap.token_out_amount)
                    
                    if back_swap.token_in_amount == front_swap.token_out_amount:
                        profit_amount = back_swap.token_out_amount - front_swap.token_in_amount
                    ...
                    return Sandwich(
                        ...
                        profit_token_address=front_swap.token_out_address,
